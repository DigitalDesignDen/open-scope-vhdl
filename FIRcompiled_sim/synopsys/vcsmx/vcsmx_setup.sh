...
TOP_LEVEL_NAME="FIRcompiled"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="G:/altera/13.0sp1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/FIRcompiled_rtl.vhd"                            
  vhdlan -xlrm "$QSYS_SIMDIR/FIRcompiled_ast.vhd"                            
  vhdlan -xlrm "$QSYS_SIMDIR/FIRcompiled.vhd"                                
  vhdlan -xlrm "$QSYS_SIMDIR/FIRcompiled_tb.vhd"                             
fi
