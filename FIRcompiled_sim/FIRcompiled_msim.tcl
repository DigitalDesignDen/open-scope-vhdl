...
transcript on
write transcript FIRcompiled_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity FIRcompiled
set timing_resolution "1ps"
set core_version 13.0
set device_family CYCLONEIII
set quartus_rootdir G:/altera/13.0sp1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists FIRcompiled.vhd]} {vcom -93 -work work FIRcompiled.vhd}
    if {[file exists FIRcompiled.v]} {vlog -work work FIRcompiled.v}
    vcom -93 -work work FIRcompiled_ast.vhd
    vcom -93 -work work FIRcompiled_rtl.vhd
