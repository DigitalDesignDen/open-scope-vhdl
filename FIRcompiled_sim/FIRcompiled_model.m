...
for j = 1:sx
    ...
    %
    file_name = ['FIRcompiled_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = FIRcompiled_mlab(data_channel, bank_channel);
      else
        output = FIRcompiled_mlab(data_channel);
      end
    ...
    file_name = ['FIRcompiled_model_output'];
