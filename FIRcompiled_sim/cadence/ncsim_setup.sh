...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/FIRcompiled_rtl.vhd"                            
  ncvhdl -v93 "$QSYS_SIMDIR/FIRcompiled_ast.vhd"                            
  ncvhdl -v93 "$QSYS_SIMDIR/FIRcompiled.vhd"                                
  ncvhdl -v93 "$QSYS_SIMDIR/FIRcompiled_tb.vhd"                             
fi
