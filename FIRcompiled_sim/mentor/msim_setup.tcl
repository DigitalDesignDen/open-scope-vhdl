...
# ACDS 13.0sp1 232 win32 2025.01.10.14:36:40
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FIRcompiled"
} 
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "G:/altera/13.0sp1/quartus/"
} 
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/FIRcompiled_rtl.vhd"                            
  vcom "$QSYS_SIMDIR/FIRcompiled_ast.vhd"                            
  vcom "$QSYS_SIMDIR/FIRcompiled.vhd"                                
  vcom "$QSYS_SIMDIR/FIRcompiled_tb.vhd"                             
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
